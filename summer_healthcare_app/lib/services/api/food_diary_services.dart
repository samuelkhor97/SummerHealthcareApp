...
class FoodDiaryServices {
  Future<List<FoodItem>> getAllFoodItems({String headerToken}) async {
    var response = await http.get(
        'https://monashhealthcare-app.herokuapp.com/food-diary/all',
        headers: {
  ...
  Future<List<FoodDiaryCard>> getAllCards(
    ...
    var response = await http.get(
        'https://monashhealthcare-app.herokuapp.com/food-diary/all-cards?date=$date',
  ...
  Future<void> createCard(
    ...
    var response = await http.post(
        'https://monashhealthcare-app.herokuapp.com/food-diary/create-card',
        headers: {'Authorization': headerToken},
  ...
  Future<bool> addFoodItem(
    ...
    var response = await http.post(
        'https://monashhealthcare-app.herokuapp.com/food-diary/add-food',
        headers: {
          'Authorization': headerToken,
        },
        body: {
